                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                               <div class="btn-group" role="group" aria-label="Basic example">
                                      ...
                                      <!-- Boton de asignacion de permisos con modal -->
                                  ...
                                  <div class="modal fade" id="modal_asignacion<?=$id_rol?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                          <div class="modal-header" style="background-color: #ec720f">
                                        ...
                                        <div class="row">
                                             <div class="col-md-3">
                                              ...
                                              <div class="col-md-6"> <!--Enlistado de permisos guardados-->
                                                    ...
                                                    $('#tabla<?=$id_rol;?>').css('display','none');
                                                     // alert("mando los datos");
                                                      Swal.fire({
                                                        position: "top-end",
                                                        icon: "success",
                                                        title: "Se registro el permiso correctamente en BD",
                                        ...
                                        <hr>
                                                <!--TABLA QUE ENLILSTA LOS PERMISOS YA ASIGNADOS A CADA ROL-->
                                ...
                                <!-- Botones de mostrar, editar y eliminar -->
                                    ...
                                    <a href="edit.php?id=<?=$id_rol;?>" type="button" class="btn btn-success btn-sm"><i class="bi bi-pencil-fill"></i></a>
                                  ...
                                  <!-- script para la opcion de eliminar -->
                                    <script>
