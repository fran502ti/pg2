              ...
              <div class="card-header">
                <h3 class="card-title">Permisos Registrados</h3>
                  <div class="card-tools">
                    <a href="create_permisos.php" class="btn btn-success"><i class="bi bi-plus-square"></i> Crear Nuevo Permiso</a>
                  </div>
              </div>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                               <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="edit_permiso.php?id=<?=$id_permiso;?>" type="button" class="btn btn-success btn-sm"><i class="bi bi-pencil-fill"></i></a>
