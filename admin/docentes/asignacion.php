...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <h1>Listado del personal docente asignado a los grados</h1>
            </div>
            <br>
            <div class="row">
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_asignarcion">
                                <i class="bi bi-plus-square"></i> Asignar grados
                            </button>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <th><center>Grado asignado</center></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <center>
                                                <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_materias<?=$id_docente;?>">
                                                    <i class="bi bi-postcard"></i> Ver Grado
                                                </button>
                                            </center>
                                            <div class="modal fade" id="modal_materias<?=$id_docente;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <h5 class="modal-title" id="exampleModalLabel"><b>Grados asignados</b></h5>
                                                                                        ...
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header" style="background-color: #0fbf0c">
                                                                                                    <h5 class="modal-title" id="exampleModalLabel"><b>Asignación de grados</b></h5>
                                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                        <span aria-hidden="true">&times;</span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                                ...
                                                                                                                <div class="form-group">
                                                                                                                    ...
                                                                                                                    <select name="id_grado" id="" class="form-control">
                                                                                                                        ...
                                                                                                                        foreach ($grados as $grado){
                                                                                                                            ...
                                                                                                                            <option value="<?=$id_grado;?>"<?=$grado['id_grado']==$asignacione['grado_id'] ? 'selected' : ''?>><?=$grado['curso']." | Seccion  ".$grado['seccion'];?></option>
                                                                                                                            <?php
                                                                                                                        }
                                                                                                                        ?>
                                                                                                                    </select>
                                                                                                            ...
                                                                                                            <div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                    ...
                                                                                                                    <select name="id_pensum" id="" class="form-control">
                                                                                                                        <?php
                                                                                                                        foreach ($pensum as $pensu){
                                                                                                                            $id_pensum = $pensu['id_pensum']; ?>
                                                                                                                            <option value="<?=$id_pensum;?>" <?=$pensu['id_pensum']==$asignacione['pensum_id'] ? 'selected' : ''?>><?=$pensu['descripcion'];?></option>
                                                                                                                            <?php
                                                                                                                        }
                                                                                                                        ?>
                                                                                                                    </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="id_grado" id="" class="form-control">
                                    ...
                                    foreach ($grados as $grado){
                                        $id_grado = $grado['id_grado']; ?>
                                        <option value="<?=$id_grado;?>"><?=$grado['curso']." | Seccion  ".$grado['seccion'];?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="id_pensum" id="" class="form-control">
                                    ...
                                    foreach ($pensum as $pensu){
                                        $id_pensum = $pensu['id_pensum']; ?>
                                        <option value="<?=$id_pensum;?>"><?=$pensu['descripcion'];?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
