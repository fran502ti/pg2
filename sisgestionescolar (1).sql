...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-10-2024 a las 05:52:25
...
(48, 'Admin', '/admin/index.php', '2024-10-12 00:00:00', '2024-10-12 00:00:00', '1'),
(49, 'Reportes', '/admin/reportes/index.php', '2024-10-14 00:00:00', NULL, '1');
...
INSERT INTO `reportes` (`id_reportes`, `docente_id`, `estudiante_id`, `materia_id`, `fecha`, `observacion`, `comentario`, `fyh_creacion`, `fyh_actualizacion`, `estado`) VALUES
(2, 10, 9, 16, '2024-10-10', 'RENDIMIENTO ACADEMICO', 'No entrego ejercicios de multiplicaciones', '2024-10-15 00:00:00', NULL, '1'),
(3, 10, 11, 13, '2024-10-15', 'RENDIMIENTO ACADEMICO', 'No entrego ejercicios de verbos y sustantivos', '2024-10-15 00:00:00', NULL, '1');
...
(79, 1, 48, '2024-10-12 00:00:00', NULL, '1'),
(80, 1, 49, '2024-10-14 00:00:00', NULL, '1'),
(81, 3, 49, '2024-10-14 00:00:00', NULL, '1');
...
--
ALTER TABLE `reportes`
  MODIFY `id_reportes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `roles_permisos`
  MODIFY `id_rol_permiso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `reportes`
  ADD CONSTRAINT `reportes_ibfk_1` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiantes` (`id_estudiante`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `reportes_ibfk_2` FOREIGN KEY (`materia_id`) REFERENCES `materias` (`id_materia`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `reportes_ibfk_3` FOREIGN KEY (`docente_id`) REFERENCES `docentes` (`id_docente`) ON DELETE NO ACTION ON UPDATE CASCADE;
