...
$sentencia = $pdo->prepare('UPDATE configuracion_institucion
...
if($sentencia->execute()){
    echo 'success';
    session_start();
    $_SESSION['mensaje']="Se actualizaron los datos de configuracion de manera correcta";
    $_SESSION['icono']="success";
    header('Location:'.APP_URL."/admin/configuraciones/institucion");
}else{
//echo 'error al registrar a la base de datos';
    session_start();
    $_SESSION['mensaje']="Error no se puede actualizar los datos en BD. Intente de nuevo.";
